...
class TestQuestionActionsMenuDisplay(TestCase):
    """
    Test that the question actions menu displays correctly
    in various contexts.
    """
    ...
    def test_owner_sees_menu_on_own_public_question_detail(self):
        """
        Test that question owner sees actions menu on their
        public question detail page.
        """
        self.client.login(username="owner", password="ownerpass123")
        response = self.client.get(
            reverse(
                "questions:detail",
                kwargs={"pk": self.public_approved_question.pk},
            )
        )
    ...
    def test_admin_sees_menu_on_others_public_question_detail(self):
        """
        Test that admin sees actions menu on another user's
        public question.
        """
    ...
    def test_other_user_does_not_see_menu_on_public_question_detail(self):
        """
        Test that other users don't see actions menu on
        someone else's public question.
        """
    ...
    def test_owner_sees_menu_on_own_question_in_list(self):
        """
        Test that question owner sees actions menu on their
        questions in the question list.
        """
        self.client.login(username="owner", password="ownerpass123")
    ...
    def test_admin_sees_menu_on_public_question_in_public_list(self):
        """
        Test that admin sees actions menu on public questions
        in the public list.
        """
        self.client.login(username="admin", password="adminpass123")
    ...
    def test_owner_sees_menu_on_pending_question_in_public_list(self):
        """
        Test that admin sees actions menu on pending questions
        in public list.
        """
    ...
    def test_other_user_does_not_see_menu_in_public_list(self):
        """
        Test that regular users don't see actions menu on
        others' public questions in list.
        """
        self.client.login(username="otheruser", password="otherpass123")
        response = self.client.get(reverse("questions:public_list"))
